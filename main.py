...
if __name__ == '__main__':
    ...
    if decon == True:
        ...
        apply_oasis(main_folder = main_folder, folder = "Grav_7_dpf/", result ="/media/thomas_sainsbury/spont/SeG/results/Baysian_network_inference/R_scirpts_for_assembly_paper/OASIS_output/WT_GR_7_dpf/")
        apply_oasis(main_folder=main_folder, folder="Grav_5_dpf/",result="/media/thomas_sainsbury/spont/SeG/results/Baysian_network_inference/R_scirpts_for_assembly_paper/OASIS_output/WT_GR_5_dpf/")
        apply_oasis(main_folder=main_folder, folder="Grav_3_dpf/",
                    result="/media/thomas_sainsbury/spont/SeG/results/Baysian_network_inference/R_scirpts_for_assembly_paper/OASIS_output/WT_GR_3_dpf/")
        apply_oasis(main_folder=main_folder, folder="WT_5_dpf/",
                result="/media/thomas_sainsbury/spont/SeG/results/Baysian_network_inference/R_scirpts_for_assembly_paper/OASIS_output/WT_NR_5_dpf/")
        apply_oasis(main_folder=main_folder, folder="WT_3_dpf/",
                   result="/media/thomas_sainsbury/spont/SeG/results/Baysian_network_inference/R_scirpts_for_assembly_paper/OASIS_output/WT_NR_3_dpf/")

    if AR1_corrs == True:
        print("calculating_corrs")
        main_folder = "/media/thomas_sainsbury/spont/Seg/results/Baysian_network_inference/R_scirpts_for_assembly_paper/OASIS_output/"
    ...
    if BCL_corrs == True:
        main_folder = "/media/thomas_sainsbury/spont/Spontaneous_activity_experiments/BCL_output/"
       ...
       # apply_correlations_all_folder(main_folder=main_folder, deconvolution_method="BCL", iter=200, remove_intro=False)
        ...
        apply_correlations_all_folder(main_folder=main_folder, deconvolution_method="AR1", iter=100, remove_intro=True,
                                      start_from=0)
        apply_correlations_all_folder(main_folder=main_folder, deconvolution_method="AR1", iter=100, remove_intro=False)

        apply_correlations_all_folder(main_folder=main_folder, deconvolution_method="estimated", iter=100, remove_intro=True,
                                      start_from=0)
        apply_correlations_all_folder(main_folder=main_folder, deconvolution_method="estimated", iter=100, remove_intro=False)
    ...
    if SNPs == True:
        ...
        combine_SNPs(main_folder="/media/thomas_sainsbury/spont/Spontaneous_activity_experiments/OASIS_output/",
                     results_folder="/media/thomas_sainsbury/spont/Spontaneous_activity_experiments/OASIS_results/SNP/",
                     remove_intro=True, deconvolution_method="estimated")
        combine_SNPs(main_folder="/media/thomas_sainsbury/spont/Spontaneous_activity_experiments/OASIS_output/",
                     results_folder="/media/thomas_sainsbury/spont/Spontaneous_activity_experiments/OASIS_results/SNP/",
    ...
    if sync_frames == True:
        '''
        apply_sync_frames(main_folder="/media/thomas_sainsbury/spont/Spontaneous_activity_experiments/BCL_output/",
                          results_folder="/media/thomas_sainsbury/spont/Spontaneous_activity_experiments/BCL_results/sync_frames_cell_num/",
        ...
        apply_sync_frames(main_folder="/media/thomas_sainsbury/spont/Spontaneous_activity_experiments/OASIS_output/",
